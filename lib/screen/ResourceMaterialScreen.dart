    ...
    return WillPopScope(
      child: Scaffold(
          ...
          body: _isLoading
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Image.asset("assets/images/ic_submission.png" , height: 22,width: 22),
                                const Gap(12),
                                Expanded(child: Text(getSet.file ?? '',style: const TextStyle(color: black,fontSize: 14,fontWeight: FontWeight.w400),)),
                                GestureDetector(
                                  behavior: HitTestBehavior.opaque,
                                  onTap: (){
              ...
              : const MyNoDataNewWidget(msg: "No Submission found yet!! \n Please upload your submission",  img: ''),
