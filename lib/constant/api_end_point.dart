...
const materialListUrl = "${MAIN_URL}manage_media/list";
const materialDetailListUrlFocDocs = "${MAIN_URL}manage_documents/list";
const materialDetailListUrl = "${MAIN_URL}manage_media/list";
